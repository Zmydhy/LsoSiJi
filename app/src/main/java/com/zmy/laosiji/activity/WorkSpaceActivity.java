...
import com.zmy.laosiji.interfaces.BaseObservable;
import com.zmy.laosiji.interfaces.HttpAPi;
import com.zmy.laosiji.interfaces.HttpOnNextListener;
import com.zmy.laosiji.interfaces.RxScheduleMapper;
...
//            new ThreadTest().setTest();
            Intent intent = new Intent(WorkSpaceActivity.this, PermissionActivity.class);
            startActivity(intent);
