...
import static com.zmy.laosiji.Utils.MyApplication.getInstance;
...
public class ConstantUtil {
    ...
    public  static void toast(String text){
        if(toast == null){
            ...
            ViewGroup layout = new RelativeLayout(getInstance());
            View view =  LayoutInflater.from(getInstance()).inflate(R.layout.common_toast, null);
