...
//            Point endPoint = new Point(500, 700);// 结束点为(700,1000)
//            // 步骤2:创建动画对象 & 设置初始值 和 结束值
//           ValueAnimator anim = ValueAnimator.ofObject(new ObjectEvaluator(), startPoint, endPoint);
//            // 参数说明
...
//                    Log.e("TAG","当前坐标：x="+currentPoint.getX()+";y:"+currentPoint.getY());
...
//                lastx = rawx;
//                lasty = rawy;
//                Log.i("TAG","rawx:"+rawx+",rawy:"+rawy+",offx:"+offx+",offy:"+offy);
//                break;
//        }
        return true;
    }
